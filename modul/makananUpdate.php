      ...
      <div class="col-md-8">
        <div class="card">
          ...
          <div class="card-body p-4">
            <form method="post" action="?page=makananUpdateProses" class="needs-validation" novalidate>
              <input type="hidden" name="id" value="<?= htmlspecialchars($data['id_makanan']) ?>">

              <div class="mb-4">
                <label for="nama_makanan" class="form-label">
                  <i class="fas fa-utensils me-2"></i>Nama Makanan
                </label>
              ...
              <div class="mb-4">
                <label for="daerah_makanan" class="form-label">
                  <i class="fas fa-map-marker-alt me-2"></i>Daerah Asal
                </label>
                <input type="text" class="form-control" id="daerah_makanan" name="daerah_makanan"
                  value="<?= htmlspecialchars($data['daerah_makanan']) ?>" required>
                <div class="invalid-feedback">
                  Mohon isi daerah asal makanan
                </div>
              </div>
              ...
              <div class="d-flex gap-2 mt-5">
                ...
                <a href="?page=makanan" class="btn btn-light">
