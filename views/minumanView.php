    ...
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
          <h3 class="mb-0"><i class="fas fa-coffee me-2"></i>Data Minuman Nusantara</h3>
          <a href="?page=minumanAdd" class="btn btn-light btn-add">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center action-buttons">
                  <a href="?page=minumanUpdate&id=<?= $data['id_minuman']; ?>" class="btn btn-warning btn-sm">
